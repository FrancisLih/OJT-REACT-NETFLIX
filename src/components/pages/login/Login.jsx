...
import { Link, useNavigate } from 'react-router-dom';
  ...
  return (
    <> 
        <div className="login bg-[url('../../img/bg-login.jpg')] h-screen bg-cover w-full isolate relative">
            ...
            <div className="form absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
                <div className="w-[450px] bg-black/70 h-[800px] rounded-md p-14">
                    ...
                    <form action="" className='text-white'> 
                        ...
                        {hasValue && (<button type="button" className='text-white absolute top-6 right-3 text-lg' onClick={handleShowPassword}>
