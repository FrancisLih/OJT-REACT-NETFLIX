        ...
        <main className='max-w-[700px] w-full bg-[#141414] text-white absolute left-1/2 top-[180px] -translate-x-1/2 z-[9999] min-h-[80px] rounded-md'>
          <div className='relative p-2'>
            ...
            {result.length !== 0 ? (
                ...
                <h3 className='font-bold mb-5 text-[#141414]'>Results keyword <span className='text-white'>{keyword}</span></h3>
                <div className='grid grid-cols-[1fr_2.5fr] gap-5'>
                    <img src={`${baseImgUrl}/movie/${result.image}`} alt="" className='w-full h-auto object-cover'/>
                    <div>
            ...
            <h3 className='text-2xl opacity-50'>No Movie Found!</h3>
      </div>) }
