...
const ModalMovieInfo = ({setMovieInfo, movieData}) => {
  ...
  return (
    <div className='fixed top-0 left-0 isolate w-full h-screen'>
        ...
        <main className='max-w-[700px] w-full bg-[#141414] text-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] max-h-[900px] h-full'>
                ...
                <div className='movie__info relative p-4 grid grid-cols-[3fr_1fr] gap-5'>
                    <div className="info">
                        <div className='duration mb-6'>
                            ...
                            <p className='p-0.5 border border-white inline text-xs'>10+</p>
                        </div>
            ...
            <div className='h-[230px] overflow-auto px-4 custom-scroll'>
            <div className='grid grid-cols-3 gap-2 max-h-[500px]'>
                    {getRelatedGenre.map((movie,key)=>(<MovieRelatedCard movie={movie} key={key}/>))}
